 ...
 */
@Entity
@Table(name = "RESERVAS", catalog = "", schema = "APP")
@NamedQueries({
...
public class Reservas implements Serializable {
    ...
    @JoinColumn(name = "NUMERO_HAB", referencedColumnName = "NUMERO_HAB")
    @ManyToOne(optional = false)
    private Habitaciones numeroHab;
    ...
    public Reservas(Integer idReserva, int idCliente, Date fechaReserva, Date fechaRegistro, Date fechaSalida, int costoAlojamiento) {
        this.idReserva = idReserva;
    ...
    public Habitaciones getNumeroHab() {
        return numeroHab;
    }

    public void setNumeroHab(Habitaciones numeroHab) {
        Habitaciones oldNumeroHab = this.numeroHab;
    ...
    public String toString() {
        return "mantenimiento.Reservas[ idReserva=" + idReserva + " ]";
    }
